...
<!-- --competency page with dot and border-- -->
...
export function CompetencyPage() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-4 pl-5 relative">
            ...
            isTrueFlag == true ? (
              <div className="flex gap-2 items-center ">
                <GoDotFill className="absolute left-0 top-1.5  text-[#7F56D9]" />
                ...
                {quessionnaireData?.prop_ques_resp.length > 0 &&
                  ...
                  quessionnaireData?.prop_ques_resp?.map((item, index) => (
                    <div>
                      <hr
                        key={index}
                        className="border-[#E4E7EC] border-l-2 absolute left-1.75 top-7 min-h-full"
                      />

                      <div className="py-6">
                        <div className="flex gap-2 items-center relative">
                          <GoDotFill className="absolute -left-5 top-1.5  text-[#7F56D9]" />
                          <span className="text-[#535862] font-bold text-lg pb-4">
      ...
      <ButtonFooter
        apiRepsonse={apiResponse.is_prop_ques_available === false}
...
<!-----competency pages code without proper border and seperation----->
...
export function CompetencyPage() {
  ...
  function PausedHandle() {
    ...
    setOpenPop(false);
    refetch();
    console.log("<<<<<<<you inside pausehandle>>>>>>>");
  }
      ...
      <section className="p-6">
        <div className="p-6 bg-white rounded-xl ">
          <div className="flex flex-col gap-4 pl-5">
            ...
            isTrueFlag == true ? (
              <>
                <div className="flex gap-2 items-center ">
                  <GoDotFill className=" text-[#7F56D9]" />
                  <h1 className="text-[18px] font-semibold leading-7 text-[#181D27]">
                    Core Question
                  </h1>
                </div>
                <p className="font-normal text-base text-[#181D27] ml-6">
                  This is the main question for this competency. Take your time
                  ...
                  quessionnaireData?.prop_ques_resp?.map((item, index) => (
                    <div>
                      <div className="py-6 ml-6">
                        <div className="flex gap-2 items-center relative">
                          <GoDotFill className="ml-4 text-[#7F56D9]" />
                          <span className="text-[#535862] font-bold text-lg pb-4">
                            Follow Up Question {index + 1}
                          </span>
                        </div>
        ...
        {apiResponse?.total_question_count
          ...
          : apiResponse?.is_prop_ques_available === false &&
            !openPop && (
              <div
                className="p-2 text-[#4d5a72] border text-[14px] bg-white border-[#D5D7DA] rounded-xl z-10000
          sticky my-4"
              >
                Your response is submitted. Please select continue to proceed to
                the next section.
              </div>
            )}
        ...
        {apiResponse?.total_question_count ? null : (
          <div className="flex justify-end py-8">
            {apiResponse?.is_prop_ques_available === false ? (
              <div className="flex gap-4">
                <button
